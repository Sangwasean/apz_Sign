...
const Main = () => {
    return ( 
        <>
        <div className="text-center mt-40 w-4/5 m-auto font-['Arial']">
            ...
            <input type="email" className=" border border-black rounded-md p-4 h-12 w-80" name="email" placeholder="Enter your email" />
            <button className="bg-red-500 rounded-md p-4 w-40 h-12 ml-4 text-white font-semibold">Try for free</button>
